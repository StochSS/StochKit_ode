...
//  printf("\n3-species chemical kinetics problem\n");
  ...
  if (sensi) {
    ...
    flag = CVodeSensInit1(cvode_mem, NUMPAR_SENSI, sensi_meth, fS, yS);
               ...
               N_Vector tmp1, N_Vector tmp2, N_Vector tmp3)
{
 ...
 /* INSERT GENERATED USER SUPPLIED JACOBIAN */

 /* END OF GENERATED USER SUPPLIED JACOBIAN */
              ...
              void *user_data, N_Vector tmp1, N_Vector tmp2)
{
 ...
 /* INSERT GENERATED USER SUPPLIED FORWARD SENSITIVITY */

 /* END OF GENERATED USER SUPPLIED FORWARD SENSITIVITY */
